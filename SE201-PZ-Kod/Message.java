...
public class Message implements ObservableChat {
    ...
    public Message(User sender, User reciever, String content, Collection<ObservableDisplay> observableDisplay) {
        this.sender = sender;
        this.reciever = reciever;
        this.content = content;
        this.observableDisplay = observableDisplay;
    }
     ...
     */
    public Iterator<ObservableDisplay> getIteratorObservableDisplay() {
        if (observableDisplay == null)
            observableDisplay = new java.util.HashSet<ObservableDisplay>();
    ...
    public void setObservableDisplay(java.util.Collection<ObservableDisplay> newObservableDisplay) {
        ...
        for (ObservableDisplay display : newObservableDisplay) addObservableDisplay(display);
    }
    ...
    public String toString() {
        return "Message{" +
                ...
                ", reciever=" + reciever +
                ", content='" + content + '\'' +
                ", observableDisplay=" + observableDisplay +
                '}';
    }
